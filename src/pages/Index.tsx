  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Bergisch Gladbach | Barber Kings Herrenfriseur</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Barber Kings Herrenfriseur in Bergisch Gladbach für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barber Kings Herrenfriseur | Premium Friseursalon Bergisch Gladbach" />
        <meta
        ...
        <meta name="twitter:title" content="Barber Kings Herrenfriseur | Premium Friseursalon Bergisch Gladbach" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Barbershop",
            "name": "Barber Kings Herrenfriseur",
